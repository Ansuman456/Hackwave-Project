...
exports.IMPLEMENTATION_USER_TEMPLATE = exports.IMPLEMENTATION_SYSTEM_PROMPT = exports.AI_RAG_USER_TEMPLATE = exports.AI_RAG_SYSTEM_PROMPT = exports.SCHEMA_CONTRACT_USER_TEMPLATE = exports.SCHEMA_CONTRACT_SYSTEM_PROMPT = exports.ARCHITECTURE_USER_TEMPLATE = exports.ARCHITECTURE_SYSTEM_PROMPT = void 0;
// ============================================================
...
`;
const ARCHITECTURE_USER_TEMPLATE = (selectedIdea, teamAnalysis, chosenTechStack, hackathonDuration, hackathonConstraints) => `
...
`;
exports.ARCHITECTURE_USER_TEMPLATE = ARCHITECTURE_USER_TEMPLATE;
// ============================================================
// SCHEMA & CONTRACT GENERATOR PROMPTS
// ============================================================
exports.SCHEMA_CONTRACT_SYSTEM_PROMPT = `
...
`;
const SCHEMA_CONTRACT_USER_TEMPLATE = (architectureOverview, components, dataFlow, selectedIdea) => `
ARCHITECTURE OVERVIEW:
...
`;
exports.SCHEMA_CONTRACT_USER_TEMPLATE = SCHEMA_CONTRACT_USER_TEMPLATE;
// ============================================================
// AI & RAG ARCHITECTURE PROMPTS
// ============================================================
exports.AI_RAG_SYSTEM_PROMPT = `
...
`;
const AI_RAG_USER_TEMPLATE = (architectureOverview, components, selectedIdea, teamCapabilities) => `
ARCHITECTURE OVERVIEW:
${architectureOverview}
...
`;
exports.AI_RAG_USER_TEMPLATE = AI_RAG_USER_TEMPLATE;
// ============================================================
// IMPLEMENTATION PLANNER PROMPTS
// ============================================================
exports.IMPLEMENTATION_SYSTEM_PROMPT = `
...
`;
const IMPLEMENTATION_USER_TEMPLATE = (architectureOverview, components, dataFlow, teamRoles, hackathonDuration, hackathonConstraints) => `
ARCHITECTURE OVERVIEW:
${architectureOverview}
...
`;
exports.IMPLEMENTATION_USER_TEMPLATE = IMPLEMENTATION_USER_TEMPLATE;
//# sourceMappingURL=ctoPrompts.js.map