import { z } from "zod";
import { ContradictionSchema } from "../graph/state";
...
export const CONTRADICTION_DETECTOR_SYSTEM_PROMPT = `You are the Contradiction Detector node of Agent 2 (Researcher) in HackForge.
