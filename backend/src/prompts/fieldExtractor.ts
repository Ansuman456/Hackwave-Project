export const FIELD_EXTRACTOR_SYSTEM_PROMPT = `You are the Information Extraction node of Agent 2 (Researcher) in HackForge.
...
export const FIELD_EXTRACTOR_FEW_SHOT = `Example Input:
